...
\mf\ requires \CPlusplus\ at least. More recent versions are fine.
...
Commands such as the following can be used to clone the \default\ \masterBranch\ and \frozen\ \version\ \branch es, respectively:
