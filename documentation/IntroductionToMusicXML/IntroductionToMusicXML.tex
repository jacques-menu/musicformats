...
\subimport{../CommonLaTeXFiles}{CommonMusicFormatsLaTeXSettings}
...
All the examples mentioned can be downloaded from \url{https://github.com/jacques-menu/musicformats/tree/master/files/musicxml}. They are grouped by subject in subdirectories, such as \gitmxmlfile{basic/HelloWorld.xml}.
