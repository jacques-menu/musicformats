...
A OAH macro atom is a combination, a std::list of several options under a single name. The \className{oahMacroAtom} class   is defined in \oahBoth{oahAtomsCollection}:
