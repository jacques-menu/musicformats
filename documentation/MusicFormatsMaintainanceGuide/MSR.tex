...
% -------------------------------------------------------------------------
\section{Uplinks and sidelinks}\label{Uplinks and sidelinks}
% -------------------------------------------------------------------------
...
\mf\ represents durations with \enumType{msrDurationKind}, defined in \msr{msrBasicTypes.h}:
\begin{lstlisting}[language=CPlusPlus]
// durations
//______________________________________________________________________________
...
They are represented in MSR with the \enumType{msrDurationKind} enumeration type, defined in \msr{msrBasicTypes.h}:
\begin{lstlisting}[language=CPlusPlus]
// durations
//______________________________________________________________________________
enum class msrDurationKind {
...
There are thus several kinds of tempos in \msrRepr, with variants represented by \enumType{msrTempoKind} in \msr{msrTempos.h}:
\begin{lstlisting}[language=CPlusPlus]
...
\item \field{msrTempo}{fTempoPerMinute} is a string, since it can contain ranges indication as in '4. = 60-66';
...
\subimport{../CommonLaTeXFiles}{MusicFormatsClassesHierarchyPicture}
...
% -------------------------------------------------------------------------
\section{Full-bar rests}\label{Full-bar rests}
% -------------------------------------------------------------------------

Full-bar rests handling is presented at \sectionRef{Full-bar rests handling}.

\Class{msrMultipleFullBarRests}, defined in \msrBoth{msrMultipleFullBarRests}, essentially contains a \class{msrMultipleFullBarRestsContents} instance and a mesure rests number:
\begin{lstlisting}[language=CPlusPlus]
class EXP msrMultipleFullBarRests : public msrVoiceElement
{
	// ... ... ...
  ...
  private:
    ...
    int                   fMultipleFullBarRestsNumber;
...
\Class{msrMultipleFullBarRestsContents} contains an \class{msrSegment} instance and an uplink:%%%JMI
\begin{lstlisting}[language=CPlusPlus]
class EXP msrMultipleFullBarRestsContents : public msrElement
{
	// ... ... ...
  ...
  private:
    ...
    // upLink
    S_msrMultipleFullBarRests fMultipleFullBarRestsContentsMultipleFullBarRestsUpLink;

    S_msrSegment          fMultipleFullBarRestsContentsSegment;
};
\end{lstlisting}
