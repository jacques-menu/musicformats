...
msrFullBarRests.h:class EXP msrFullBarRests : public msrVoiceElement
...
formats/msr/msrFullBarRests.h:class EXP msrFullBarRests : public msrVoiceElement
...
\Class{msrFullBarRests}, defined in \msrBoth{msrFullBarRests}, essentially contains a \class{msrFullBarRestsContents} instance and a mesure rests number:
\begin{lstlisting}[language=CPlusPlus]
...
\Class{msrFullBarRestsContents} contains an \class{msrSegment} instance and an uplink:
\begin{lstlisting}[language=CPlusPlus]
