...
class EXP msrIdentification : public msrElement
{
 // ... ... ...
  ...
  private:
    ...
    std::list<std::string>          fSoftwaresList;
...
An \class{msrMeasuresSlice} contains basically a slice measures std::vector:
\begin{lstlisting}[language=CPlusPlus]
...
An \class{msrBook} contains a std::list and a set of {\tt S_msrBookElement}:
\begin{lstlisting}[language=CPlusPlus]
    // book elements
...
which are stored in a std::list:
\begin{lstlisting}[language=CPlusPlus]
...
\begin{lstlisting}[language=CPlusPlus]
    ...
    std::map<int, S_msrStaff>  getPartStaveNumbersToStavesMap;
...
\Class{msrRepeatCommonPart} contains a std::list of \class{msrVoiceElement}:
\begin{lstlisting}[language=CPlusPlus]
  private:
...
\Class{msrRepeatEnding} contains a std::list of \class{msrVoiceElement} too, as well as a \enumType{msrRepeatEndingKind} field:
\begin{lstlisting}[language=CPlusPlus]
  private:
