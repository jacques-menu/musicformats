...
\EnumType{msrDurationKind} is declared in \msr{msrDurations.h}:
\begin{lstlisting}[language=CPlusPlus]
...
Measure positions are represented by \code{Rational} numbers such as {\tt 3/8}, {\tt 1/1} being a whole note.

Measure positions are stored in \field{msrMeasureElement}{fMeasureElementMeasurePosition} in \class{msrMeasureElement}, defined in \msrBoth{msrMeasureElement}:
\begin{lstlisting}[language=CPlusPlus]
