...
\item \method{msrFullBarRests}{appendMeasureCloneToFullBarRests} called from:\bigskip\\%%% \\visitorMethod{msr2lpsrTranslator}{visitStart (S_msrMeasure\& elt) commented
			\indentedBox{
  			\visitorMethod{msr2msrTranslator}{visitStart (S_msrMeasure\& elt)}
			}
...
\item \method{msrVoice}{createNewLastSegmentFromItsFirstMeasureForVoice} called from:\bigskip\\%%%JMI \method{msrVoice}{addEmptyMeasuresToVoice} commented
			\indentedBox{
  			...
  			\method{msrVoice}{createFullBarRestsInVoice}
			}
