...
For example, \globalVariable{gGlobalCurrentServiceRunData} is supplied by \mflibraryBoth{mfServiceRunData}: %%%JMI
\begin{lstlisting}[language=CPlusPlus]
EXP extern S_generalOahGroup gGlobalCurrentServiceRunData;
...
S_generalOahGroup createGlobalGeneralOahGroup ()
{
  ...
  if (! gGlobalCurrentServiceRunData) {
    // create the global general options group
    gGlobalCurrentServiceRunData =
      generalOahGroup::create ();
    assert (gGlobalCurrentServiceRunData != 0);
  }

  // return the global OAH group
  return gGlobalCurrentServiceRunData;
}
\end{lstlisting}
