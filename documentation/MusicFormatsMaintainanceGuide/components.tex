...
\item a set of multi-pass converters are supplied, such as \xmlToLy\, \xmlToXml\ and \msdLangComp.%%%JMI
\end{itemize}

In the \mf\ user's documentation, the term '\converter' is used because it is more meaningfull for musicians.
