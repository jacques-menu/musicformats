...
The built files are in \distrib{bin}, \distrib{lib} and \distrib{libdir}. There is a \code{clean} target in the \code{Makefile}. They can be removed in a single step with \code{make clean}.
\begin{lstlisting}[language=Terminal]
...
% -------------------------------------------------------------------------
\section{Locating a bug at random}
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
\section{Locating a bug with Git's bisection}
% -------------------------------------------------------------------------
