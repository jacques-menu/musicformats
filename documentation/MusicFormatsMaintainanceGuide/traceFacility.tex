...
Tracing is controlled by {\tt MF_TRACING_IS_ENABLED}, defined or nor in \oah{mfEnableTracingSetting.h}:
...
Be sure to build \mf\ with \code{MF_TRACING_IS_ENABLED} both active and commented out before creating a new \code{v*} \version\ \branch, to check that variables scopes are fine.
