...
The \markupName{harmony} markup occurs at the measure level in \mxml, as notes do, but they apply at the part level, even though this is not explictly stated, since there is no staff nor voice information associated with them:
...
The harmony \markup{function}, defined in \mxml, is a string. It is stored in the \class{msrHarmony}, but nothing more. No example of that is present in \mxmlfiles, actually.
\begin{lstlisting}[language=Terminal]
...
The \mxml\ 4.0 \markup{numeral} markup is described at \url{https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/numeral/}.
Examples are:
