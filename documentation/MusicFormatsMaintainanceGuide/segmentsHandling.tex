...
\item \method{msrVoice}{handleFullMeasureRestsStartInVoiceClone}\\[-0.5ex]
...
All the uses of this method concern repeats (\sectionRef{Repeats handling}), measure repeats (\sectionRef{Measure repeats handling}) and full measure rests(\sectionRef{Full measure rests handling}).
