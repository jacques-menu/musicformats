...
\class{oahAtomStoringAValue}: there isn't any value to be supplied in the command line, since \fieldName{fBooleanVariable} is \code{false} by default and becomes \code{true} when the options is chosen:
\begin{lstlisting}[language=CPlusPlus]
