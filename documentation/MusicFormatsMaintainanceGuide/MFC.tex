...
An instance of \className{mfcVersionsHistory} is essentially a std::list of \className{mfcVersionsHistory} instances:
\begin{lstlisting}[language=CPlusPlus]
...
For example, the formats and passes used by the \fileName{musicxml2braille} converter are appended to the atoms versions std::list in its history in \function{createMusicxml2brailleConverterComponent} in \\
