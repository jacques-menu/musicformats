...
Upon the second visit of \class{msrNote}, the part figured bass voice is created if figured bass elements are not to be ignored due to option \optionBoth{ignore-figured-bass}{ofigbass} and it has not been created yet:
\begin{lstlisting}[language=CPlusPlus]
