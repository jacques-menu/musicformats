...
There are many such pre-declations in \mf. We thus use a couple of \fileName{*EnumTypes*} files to contain most of them, in order to avoid numerous header file includes:
\begin{lstlisting}[language=CPlusPlus]
...
\mf, has classes declarations in separate header files as much as possible.
