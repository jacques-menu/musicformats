...
The C++11 language is needed because \mf\ uses \fileName{$<$regex$>$} and the {\tt auto}\index[Main]{auto} keyword. More recent versions should not be a problem.
...
% -------------------------------------------------------------------------
\section{One-shot partial make runs}
% -------------------------------------------------------------------------

Some parts of the source code base have to be created by their own \code{make} file once and for all. %%%JMI
...
This \fileName{Makefile} is \build{Makefile}.
...
This \fileName{Makefile} is \clisamples{Makefile}.
