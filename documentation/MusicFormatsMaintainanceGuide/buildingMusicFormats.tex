...
The \CPlusplus\ language is needed because \mf\ uses \fileName{$<$regex$>$} and the {\tt auto}\index[Main]{auto} keyword. More recent versions should not be a problem.
...
Some parts of the source code base have to be created by their own \make\ file once and for all. %%%JMI
