...
Braille cells are output to an \fileName{std::ostream} as hexadecimal strings by \virtualMethod{generateCodeForBrailleCell} methods in \bsrToBraille{brailleGeneration.h}, depending on the kind of output chosen.
