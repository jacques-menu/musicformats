...
All the uses of this method concern repeats (\sectionRef{Repeats handling}), measure repeats (\sectionRef{Measure repeats handling}) and multi-measure rests(\sectionRef{Multi-measure rests handling}).
