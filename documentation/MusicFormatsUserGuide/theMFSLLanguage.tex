...
Let us go one step further: \mfsl{Hymn121ForVocalSATBQuartet.mfsl} a selection criterion in  to obtain scores for a vocal SATB (soprano, alto, tenor, bass) choir.

This is done in the \mfsl{Hymn121ForVocalSATBQuartet.mfsl} \script:
\begin{lstlisting}[language=Terminal]
