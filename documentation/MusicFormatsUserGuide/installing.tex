...
For example, the v0.9.63 distributions are at \url{https://github.com/jacques-menu/musicformats/tree/v0.9.63/distrib}.

The contents is:
\begin{lstlisting}[language=Terminal]
jacquesmenu@mac-mini-de-jacques-1:~/musicformats-git-dev/distrib > ls -sal
total 40
 0 drwxr-xr-x   9 jacquesmenu  staff   288 Aug  4 07:27 .
 0 drwxr-xr-x  37 jacquesmenu  staff  1184 Jul 29 09:59 ..
 0 drwxr-xr-x   2 jacquesmenu  staff    64 Jul 24 12:49 MusicFormatsForMacOS
 8 -rw-r--r--@  1 jacquesmenu  staff   192 Jul 24 12:49 MusicFormatsForMacOS.zip
 0 drwxr-xr-x   2 jacquesmenu  staff    64 Jul 24 12:49 MusicFormatsForUbuntu
 8 -rw-r--r--   1 jacquesmenu  staff   194 Jul 24 12:49 MusicFormatsForUbuntu.zip
 0 drwxr-xr-x   2 jacquesmenu  staff    64 Jul 24 12:49 MusicFormatsForWindows
 8 -rw-r--r--   1 jacquesmenu  staff   196 Jul 24 12:49 MusicFormatsForWindows.zip
\end{lstlisting}

The distributions \zip\ archives are supplied with all versions, i.e. the current, most recent version of \mf (the default branch in the \repo), and the earlier versions such as the \code{v0.9.63} branch.
