...
\begin{titlepage}
  \begin{center}
    ...
    \textbf{
      \LARGE{\mf\ command line user guide} \\[10pt]
...
This document shows how to use the \mf\ library, both from the \CLI\ and from within applications. It is part of the \mf\ documentation, and can be found at \gitdocpdf{MusicFormatsCLIUserGuide}{MusicFormatsCLIUserGuide.pdf}.
