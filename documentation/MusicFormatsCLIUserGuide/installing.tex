...
Depending on the needs, users may wish to install the \MainIt{whole} \mf\ with source code and examples, or to do a \MainIt{basic installation}, that contains only the \MainIt{libraries}, \CLI\ executables and documentation \pdf\ files.
...
% -------------------------------------------------------------------------
\section{Windows\texttrademark\ basic installation}
% -------------------------------------------------------------------------
