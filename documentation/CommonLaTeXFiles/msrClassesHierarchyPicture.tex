...
\caption {The \msrRepr\ classes hierarchy}
...
% ------------------------------------------------
\node [fill=\RepeatRectanglesBackgroundColor]
  (msrMultipleFullBarRests) at (msrMultipleFullBarRests) {\texttt {\textbf{msrMultipleFullBarRests}}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrFiguredBassElement) at (msrFiguredBassElement) {\texttt {\textbf{msrFiguredBassElement}}};
