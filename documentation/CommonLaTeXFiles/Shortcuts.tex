...
\newcommand{\link}{link}\index[Main]{link}
\newcommand{\shortcut}{shortcut}\index[Main]{shortcut}
\newcommand{\upLink}{uplink}\index[Main]{uplink}
\newcommand{\sideLink}{sidelink}\index[Main]{sidelink}
...
\newcommand{\pim}{measure position\index[Main]{measure position}}
...
\newcommand{\typeName}[1]{%
{\tt #1}\index[Main]{{\tt #1}}\index[Main]{type}\index[Types]{{\tt #1}}% JMI v0.9.66
}
...
\newcommand{\subClass}{%
sub-class\index[Main]{sub-class}%
}
\newcommand{\SubClass}{%
Sub-class\index[Main]{Sub-class}%
}
