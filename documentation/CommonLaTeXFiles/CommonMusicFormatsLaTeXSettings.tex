...
\newcommand{\mfslLangInterp}{MFSL interpreter}
\newcommand{\mfslconverter}{{\tt mfslconverter}}
...
\newcommand{\CPlusplus}{C++17\index[Main]{C++17}}
...
\newcommand{\scripts}[1]{%
{\textcolor{brown}{\tt scripts/#1}}\index[Files]{scripts!#1}%
}
...
\newcommand{\mfsl}[1]{%
{\textcolor{brown}{\tt src/interpreters/mfsl/#1}}\index[Main]{#1}\index[Files]{src/interpreters/mfsl!#1}%
}
\newcommand{\mfslBoth}[1]{%
{\textcolor{brown}{\tt src/interpreters/mfsl/#1.h/.cpp}}\index[Files]{src/interpreters/mfsl!#1.h/.cpp}%
}
