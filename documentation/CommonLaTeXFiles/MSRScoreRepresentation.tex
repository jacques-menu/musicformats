...
\tikzmath{
  ...
  %
  \MultiMeasureRestsOrd  = \SegmentElementOrd - 0.75 mm;
  \MeasureRepeatOrd         = \MultiMeasureRestsOrd - 0.75 mm;
...
\coordinate (MultiMeasureRests)     at (\rightColumnAbs,\MultiMeasureRestsOrd);
...
% ------------------------------------------------
\node [fill=\RepeatRectanglesBackgroundColor]
  (MultiMeasureRests) at (MultiMeasureRests) {\texttt {\textbf {MultiMeasureRests}}};
