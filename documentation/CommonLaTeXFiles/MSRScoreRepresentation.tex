...
\tikzmath{
  ...
  \FiguredBassElementOrd    = \MeasureElementOrd - 1.5 mm;
  %
...
%  \TupletOrd         = \MeasureElementOrd - 2 mm;
  ...
  %
  \FiguredBassElementToNoteExternalPointAbs = \leftColumnAbs - 0.5 mm;
  \FiguredBassElementToNoteExternalPointOrd = \NoteOrd + 0.5 mm;
  %
...
\coordinate (FiguredBassElement)      at (\leftColumnAbs,\FiguredBassElementOrd);
...
\coordinate (FiguredBassElementToNoteExternalPoint)    at (\FiguredBassElementToNoteExternalPointAbs,\FiguredBassElementToNoteExternalPointOrd);
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (FiguredBassElement) at (FiguredBassElement) {\texttt {\textbf {FiguredBassElement}}};
...
\draw [->, thick, \usedByClassArcsColor]
  ...
  (FiguredBassElementToNoteExternalPoint);
