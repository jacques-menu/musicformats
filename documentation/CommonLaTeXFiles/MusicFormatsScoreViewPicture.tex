...
\tikzmath{
  ...
  \msrFullMeasureRestsOrd   = \msrRepeatOrd - 0.75 mm;
  \msrMeasureRepeatOrd = \msrFullMeasureRestsOrd - 0.75 mm;
...
\coordinate (msrFullMeasureRests)     at (\rightColumnAbs,\msrFullMeasureRestsOrd);
...
% ------------------------------------------------
\node [fill=\RepeatRectanglesBackgroundColor]
  (msrFullMeasureRests) at (msrFullMeasureRests) {\texttt {\textbf {FullMeasureRests}}};
