...
\tikzmath{
  ...
  \msrFullBarRestsOrd   = \msrRepeatOrd - 0.75 mm;
  \msrMeasureRepeatOrd = \msrFullBarRestsOrd - 0.75 mm;
...
\coordinate (msrFullBarRests)     at (\rightColumnAbs,\msrFullBarRestsOrd);
...
% ------------------------------------------------
\node [fill=\RepeatRectanglesBackgroundColor]
  (msrFullBarRests) at (msrFullBarRests) {\texttt {\textbf {FullBarRests}}};
