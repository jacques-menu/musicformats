...
\caption {The MusicFormats score view}

%\begin{sidecaption}[fortoc]{title}[label]
%the body of the float
%\end{sidecaption}

\label{The MusicFormats score view}
...
\tikzmath{
  ...
  \msrFiguredBassElementOrd    = \msrMeasureElementOrd - 1.5 mm;
  %
  \msrRepeatOrd       	= \msrVoiceElementOrd - 0.75 mm;
  \msrMultipleFullBarRestsOrd   = \msrRepeatOrd - 0.75 mm;
  \msrMeasureRepeatOrd = \msrMultipleFullBarRestsOrd - 0.75 mm;
...
%  \msrTupletOrd         = \msrMeasureElementOrd - 2 mm;
  ...
  %
  \msrFiguredBassElementToNoteExternalPointAbs = \leftColumnAbs - 0.5 mm;
  \msrFiguredBassElementToNoteExternalPointOrd = \msrNoteOrd + 0.5 mm;
  %
...
\coordinate (msrFiguredBassElement)      at (\leftColumnAbs,\msrFiguredBassElementOrd);
...
\coordinate (msrMultipleFullBarRests)     at (\rightColumnAbs,\msrMultipleFullBarRestsOrd);
...
\coordinate (msrFiguredBassElementToNoteExternalPoint)    at (\msrFiguredBassElementToNoteExternalPointAbs,\msrFiguredBassElementToNoteExternalPointOrd);
...
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrNote) at (msrNote) {\texttt {\textbf {Note}}};
...
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrBook) at (msrBook) {\texttt {\textbf {Book}}};


\node[fill=\ElementsRectanglesBackgroundColor]
  (msrBookElement) at (msrBookElement) {\texttt {BookElement}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrScore) at (msrScore) {\texttt {\textbf {Score}}};
...
% before the downward links
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrPartGroup) at (msrPartGroup) {\texttt {\textbf {PartGroup}}};

\node [fill=\ElementsRectanglesBackgroundColor]
  (msrPartGroupElement) at (msrPartGroupElement) {\texttt {PartGroupElement}};
...
% ------------------------------------------------
\node[fill=\PrimaryRectanglesBackgroundColor]
  (msrPart) at (msrPart) {\texttt {\textbf {Part}}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrStaff) at (msrStaff) {\texttt {\textbf {Staff}}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrVoice) at (msrVoice) {\texttt {\textbf {Voice}}};

\node [fill=\ElementsRectanglesBackgroundColor]
  (msrVoiceElement) at (msrVoiceElement) {\texttt {VoiceElement}};
...
\node [fill=\SecondaryRectanglesBackgroundColor]
  (msrSegment) at (msrSegment) {\texttt {Segment}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrMeasure) at (msrMeasure) {\texttt {\textbf {Measure}}};

\node [fill=\ElementsRectanglesBackgroundColor]
  (msrMeasureElement) at (msrMeasureElement) {\texttt {MeasureElement}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrStanza) at (msrStanza) {\texttt {\textbf {Stanza}}};
...
% ------------------------------------------------
\node [fill=\SecondaryRectanglesBackgroundColor]
  (msrSyllable) at (msrSyllable) {\texttt {Syllable}};
...
\node [fill=\RepeatRectanglesBackgroundColor]
  (msrRepeat) at (msrRepeat) {\texttt {\textbf {Repeat}}};
...
% ------------------------------------------------
\node [fill=\RepeatRectanglesBackgroundColor]
  (msrMultipleFullBarRests) at (msrMultipleFullBarRests) {\texttt {\textbf {MultipleFullBarRests}}};
...
% ------------------------------------------------
\node [fill=\RepeatRectanglesBackgroundColor]
    (msrMeasureRepeat) at (msrMeasureRepeat) {\texttt {\textbf {MeasureRepeat}}};
...
% ------------------------------------------------
\node [fill=\RepeatRectanglesBackgroundColor]
  (msrBeatRepeat) at (msrBeatRepeat) {\texttt {\textbf {BeatRepeat}}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrHarmony) at (msrHarmony) {\texttt {\textbf {Harmony}}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrFiguredBassElement) at (msrFiguredBassElement) {\texttt {\textbf {FiguredBassElement}}};
...
\draw [->, thick, \usedByClassArcsColor]
  ...
  (msrFiguredBassElementToNoteExternalPoint);
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrDoubleTremolo) at (msrDoubleTremolo) {\texttt {\textbf {DoubleTremolo}}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrGraceNotesGroup) at (msrGraceNotesGroup) {\texttt {\textbf {GraceNotesGroup}}};
...
% before the downward links
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrTuplet) at (msrTuplet) {\texttt {\textbf {Tuplet}}};

\node [fill=\ElementsRectanglesBackgroundColor]
  (msrTupletElement) at (msrTupletElement) {\texttt {TupletElement}};
...
% ------------------------------------------------
\node [fill=\PrimaryRectanglesBackgroundColor]
  (msrChord) at (msrChord) {\texttt {\textbf {Chord}}};
