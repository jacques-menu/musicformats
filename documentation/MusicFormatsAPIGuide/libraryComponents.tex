...
\item \mf\ also provides various examples and tools to create and manipulate music scores.%%%JMI
\end{itemize}
...
%\midi\ & binary data containg markups such as \musicXmlMarkup{part-std::list}, \musicXmlMarkup{time} and \musicXmlMarkup{note};
%\tabularnewline
