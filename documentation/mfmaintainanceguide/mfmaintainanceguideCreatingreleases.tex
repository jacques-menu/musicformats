...
\includegraphics[scale=0.35]{../mfgraphics/MacOSAllowAnyway.png}
...
we get for example:\\
\includegraphics[scale=0.45]{../mfgraphics/GitHubWorkflowsResults.png}

Then cliking on the link leads to:\\
\includegraphics[scale=0.45]{../mfgraphics/GitHubUbuntuActionResult.png}
