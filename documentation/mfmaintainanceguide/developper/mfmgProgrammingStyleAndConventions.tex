...
formats/lpsr/lpsrPartBlocks.h:27:class EXP lpsrPartBlock : public lpsrElement
...
\begin{lstlisting}[language=CPlusPlus]
EXP S_mxsr2msrOahGroup createGlobalMxsrOahGroup ();
\end{lstlisting}
...
A whole notes value is described by \class{mfWholeNotes}, defined in \msrBoth{msrNotesDurations}. It contains a numerator and denominator, as \class{msrRational} does, but those types are distinct, since an \className{mfWholeNotes} instance is a fraction of a whole note, note a mere typeless fraction.

\mf\ uses \className{mfWholeNotes} instances for notes sounding and display whole notes values;
...
{
  // replace spaces in partMusicXMLID to set fPartMusicXMLID
  for_each (
...
oah/oahBasicTypes.h:    const std::multiset <S_oahPrintableElement, compareOahElements>&
oah/oahBasicTypes.h:    std::multiset <S_oahPrintableElement, compareOahElements>
...
formats/msr/msrMeasureElementsWithoutUpLinkToMeasure.h:    static bool           compareMeasureElementsByIncreasingPositionInMeasure (
...
formats/lpsr/lpsrPartBlocks.h:    static bool           compareElementsToHaveHarmoniesAboveCorrespondingStaff (
formats/lpsr/lpsrPartBlocks.h:    static bool           compareStaffBlockWithOtherElement (
formats/lpsr/lpsrPartBlocks.h:    static bool           compareChordNamesContextWithOtherElement (
