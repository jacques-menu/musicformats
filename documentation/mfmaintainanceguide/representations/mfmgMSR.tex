...
\Class{msrMultipleMeasureRest}, defined in \msrBoth{msrMultipleMeasureRest}, essentially contains a liste of \class{_msrMeasure} instances and a multi-measure rests number:
\begin{lstlisting}[language=CPlusPlus]
