...
\item \method{msrMultiMeasureRest}{appendMeasureCloneToMultiMeasureRests} called from:\bigskip\\%%% \\visitorMethod{msr2lpsrTranslator}{visitStart (S_msrMeasure\& elt) commented
			\indentedBox{
  			\visitorMethod{msr2msrTranslator}{visitStart (S_msrMeasure\& elt)}
			}
...
\item \method{msrVoice}{createNewLastSegmentFromItsFirstMeasureForVoice} called from:\bigskip\\%%%JMI \method{msrVoice}{appendEmptyMeasuresToVoice} commented
			\indentedBox{
  			...
  			\method{msrVoice}{appendMultiMeasureRestToVoice}
			}
...
% -------------------------------------------------------------------------
\section{Translating measures from MSR to MSR}
% -------------------------------------------------------------------------
