...
All the uses of this method concern repeats (\sectionRef{Repeats}), measure repeats (\sectionRef{Measure repeats}) and multiple measure rests(\sectionRef{Multiple measure rests}).
