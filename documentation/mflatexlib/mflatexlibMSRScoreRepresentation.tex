...
\tikzmath{
  ...
  %
  \MultipleMeasureRestsOrd  = \SegmentElementOrd - 0.75 mm;
  \MeasureRepeatOrd         = \MultipleMeasureRestsOrd - 0.75 mm;
  ...
  %
  \TupletElementAbs  = 0 mm;
	\TupletElementOrd  = \MeasureElementOrd - 2 mm;
%
  \TupletAbs         = - \rightColumnAbs * 0.6;
	\TupletOrd         = \TupletElementOrd - 1.25 mm;
%
  \GraceNotesGroupOrd = \TupletElementOrd - 2.5 mm;
  %
  \ChordOrd          = \TupletElementOrd - 3.75 mm;
...
\coordinate (MultipleMeasureRests)     at (\rightColumnAbs,\MultipleMeasureRestsOrd);
\coordinate (MeasureRepeat)   at (\rightColumnAbs,\MeasureRepeatOrd);
\coordinate (BeatRepeat)      at (\rightColumnAbs,\BeatRepeatOrd);

\coordinate (TupletElement)    at (\TupletElementAbs,\TupletElementOrd);
...
% ------------------------------------------------
\node [fill=\RepeatRectanglesBackgroundColor]
  (MultipleMeasureRests) at (MultipleMeasureRests) {\texttt {\textbf {MultipleMeasureRests}}};
