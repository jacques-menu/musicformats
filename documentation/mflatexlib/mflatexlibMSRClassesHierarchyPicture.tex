...
\tikzmath{
  ...
  %
  \msrMultipleMeasureRestOrd  = \msrSegmentElementOrd - 0.75 mm;
  \msrMeasureRepeatOrd         = \msrMultipleMeasureRestOrd - 0.75 mm;
...
\coordinate (msrMultipleMeasureRest)     at (\rightColumnAbs,\msrMultipleMeasureRestOrd);
...
% ------------------------------------------------
\node [fill=\RepeatRectanglesBackgroundColor]
  (msrMultipleMeasureRest) at (msrMultipleMeasureRest) {\texttt {\textbf {msrMultipleMeasureRest}}};
