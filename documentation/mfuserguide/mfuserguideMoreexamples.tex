...
\includegraphics[scale=1]{../mfgraphics/Anacrusis_Jianpu.png}

This is to be compared with:\\
\includegraphics[scale=1]{../mfgraphics/Anacrusis.png}
...
\includegraphics[scale=1]{../mfgraphics/Anacrusis_Braille.png}
...
\includegraphics[scale=0.7]{../mfgraphics/Anacrusis_Guido.png}
...
\includegraphics[scale=0.7]{../mfgraphics/Anacrusis_From_xml2xml.png}
