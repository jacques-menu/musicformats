...
\includegraphics[scale=0.5]{../mfgraphics/ReadyToUseVersionContents.png}

Once uncompressed on the user's machine, the contents looks like:\\
\includegraphics[scale=0.5]{../mfgraphics/ReadyToUseVersionContentsExample.png}
...
\includegraphics[scale=0.35]{../mfgraphics/MacOSMaliciousSoftwareAlert.png}
