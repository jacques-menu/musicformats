...
The use of \mf\ through its \API s is described in a specific documentation, to be found at \gitdocpdf{mfapiguide}{mfapiguide.pdf}. This is intended for users who create applications such as \Web\ sites that do not use command line commands, but call functions\index{functions} provided by the library instead. The exact same functionality is available this way.
