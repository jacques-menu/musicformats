...
MUSIC_FORMATS_TEST=${HOME}/musicformats-git-test
alias mftest="cd ${MUSIC_FORMATS_TEST}"
alias mft=mftest

# master branch
#----------------------------------------------

MUSIC_FORMATS_MASTER=${HOME}/musicformats-git-master
alias mfmaster="cd ${MUSIC_FORMATS_MASTER}"
alias mfm=mfmaster
