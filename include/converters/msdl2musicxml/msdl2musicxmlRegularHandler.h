...
#ifndef ___msdl2musicxmlRegularHandler___
#define ___msdl2musicxmlRegularHandler___
...
/*
  An msdl2musicxml regular OAH handler can rely on the existence of an insider handler,
...
*/
{
  ...
  protected:
    ...
    virtual               ~msdl2musicxmlRegularHandler ();
