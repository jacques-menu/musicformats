...
#ifndef ___displayMsrVoicesFlatViewVisitor___
#define ___displayMsrVoicesFlatViewVisitor___
...

{
  ...
  public:
    ...
    void                  printMsrScoreVoicesFlatView (
...
#endif // ___displayMsrVoicesFlatViewVisitor___
