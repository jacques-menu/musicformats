...
class EXP ischemeInput : public smartable
{
  ...
  private:
    ...
    map<std::string, S_ischemeOptionsBlock>
...
class EXP ischemeInputsTable : public smartable
{
  ...
  public:
    ...
    const map<std::string, S_ischemeInput>&
                          getInputsMap () const
                              { return fInputsMap; }
...
class EXP ischemeCaseInputStatement : public smartable
{
  ...
  public:
    ...
    const list<std::string>&   getCaseInputCurrentNamesList () const
...
//                             const std::string& name);
  ...
  private:
    ...
    map<std::string, S_ischemeChoice>
                          fChoicesMap;
};
