...
//______________________________________________________________________________
class EXP ischemeInterpreterOahGroup : public oahGroup
{
  public:
    ...
    static SMARTP<ischemeInterpreterOahGroup> create ();
  ...
  private:
    ...
    void                  initializeIschemeInterpreterOahGroup ();
  ...
  protected:
    ...
    // ------------------------------------------------------
                          ...
                          ischemeInterpreterOahGroup ();

    virtual               ~ischemeInterpreterOahGroup ();
...
// JMI    void                  initializeischemeInterpretertracingOah ();
  ...
  public:
    ...
    void                  printIschemeInterpreterOahHelp ();

    void                  printIschemeInterpreterOahValues (
                            int fieldWidth);
...
//______________________________________________________________________________
EXP S_ischemeInterpreterOahGroup createGlobalIschemeInterpreterOahGroup ();
