...
*/
  ...
  public:
    ...
    std::string           getMxsrPartGroupCombinedName () const
                              {
                                return
...
//     S_mxsrPartGroup       fetchMxsrPartGroupsStackTop ();
    ...
    std::vector<std::list<S_mxsrPartGroup> >
    ...
    void                  displayIdentitysOfStartedMxsrPartGroupsVector (
                            int inputLineNumber);
