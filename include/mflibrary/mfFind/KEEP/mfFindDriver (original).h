...
class mfFindDriver
{
  ...
  public:
    ...
    const mfFind::location& getScannerLocation () const
    ...
    S_mfFindChoicesTable    getChoicesTable () const
                              { return fChoicesTable; }

    void                  setCurrentChoiceChoice ( S_mfFindChoice choice)
                              { fCurrentChoiceChoice = choice; }

    S_mfFindChoice          getCurrentChoiceChoice () const
    ...
    S_mfFindInputsTable     getInputsTable () const
                              { return fInputsTable; }
  ...
  public:
    ...
    S_mfFindOptionsBlock    optionsBlocksStackTop () const;
    ...
    mfMusicformatsErrorKind   launchmfFindService_Pass2 ();
...
//                             const std::string&      label);
  ...
  private:
    ...
    // choices handling
    S_mfFindChoicesTable    fChoicesTable;
    ...
    list<S_mfFindCaseChoiceStatement>
                          fCaseChoiceStatementsStack;

    S_mfFindChoice          fCurrentChoiceChoice;

    // inputs handling
    S_mfFindInputsTable     fInputsTable;
    ...
    list<S_mfFindCaseInputStatement>
                          fCaseInputStatementsStack;

    // options blocks
    list<S_mfFindOptionsBlock>
                          fOptionsBlocksStack;

    S_mfFindOptionsBlock    fMainOptionsBlock;
