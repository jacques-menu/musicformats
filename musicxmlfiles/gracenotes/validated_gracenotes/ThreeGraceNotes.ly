...
% Generated from "ThreeGraceNotes.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 15:59:39 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name ThreeGraceNotes.ly ThreeGraceNotes.xml
% or, with short option names:
%     ThreeGraceNotes.ly ThreeGraceNotes.xml
...
\header {
  workCreditTypeTitle = "Three Grace Notes"
  encodingDate        = "2016-12-12"
  software            = "Frescobaldi 2.18.1"
  title               = "Three Grace Notes"
}
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \clef "treble"
  \time 4/4
\grace { e''32  f''32  g''32 } \stemDown a''1 }
