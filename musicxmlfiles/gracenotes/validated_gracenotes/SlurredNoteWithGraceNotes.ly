...
% Generated from "SlurredNoteWithGraceNotes.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 15:59:38 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name SlurredNoteWithGraceNotes.ly SlurredNoteWithGraceNotes.xml
% or, with short option names:
%     SlurredNoteWithGraceNotes.ly SlurredNoteWithGraceNotes.xml
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \key f \major
  \time 4/4
  \grace { b'!8 } \stemDown c''4. ^\markup { "Andantino" } ( \stemUp aes'!8 ) aes' [
  ( f' ees'! f' ]
) }
