...
% Generated from "SingleGraceNote.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 15:59:37 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name SingleGraceNote.ly SingleGraceNote.xml
% or, with short option names:
%     SingleGraceNote.ly SingleGraceNote.xml
...
\header {
  workCreditTypeTitle = "Simple Grace Notes"
  movementTitle       = "Simple Grace Notes"
  encodingDate        = "2025-03-27"
