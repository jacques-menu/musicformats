...
% Generated from "SeveralHarmonies_From_MuseScore.xml"
% by xml2ly 0.9.76-dev (built on September 10, 2025)
% on Wednesday 2025-09-10 @ 17:30:11 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name SeveralHarmonies_From_MuseScore.ly SeveralHarmonies_From_MuseScore.xml
% or, with short option names:
%     SeveralHarmonies_From_MuseScore.ly SeveralHarmonies_From_MuseScore.xml
...
\header {
  workCreditTypeTitle = "Several Harmonies"
  encodingDate        = "2023-02-27"
  software            = "MuseScore 3.6.2"
  title               = "Several Harmonies"
}
