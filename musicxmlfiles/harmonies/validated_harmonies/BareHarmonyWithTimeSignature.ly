...
% Generated from "BareHarmonyWithTimeSignature.xml"
% by xml2ly 0.9.76-dev (built on September 10, 2025)
% on Wednesday 2025-09-10 @ 17:30:05 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name BareHarmonyWithTimeSignature.ly BareHarmonyWithTimeSignature.xml
% or, with short option names:
%     BareHarmonyWithTimeSignature.ly BareHarmonyWithTimeSignature.xml
...
\header {
  workCreditTypeTitle = "Bare Harmony With Time Signature"
  title               = "Bare Harmony With Time Signature"
}
