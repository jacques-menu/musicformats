...
% Generated from "SeveralHarmoniesNoNoteWithoutAHarmony.xml"
% by xml2ly 0.9.76-dev (built on September 10, 2025)
% on Wednesday 2025-09-10 @ 17:30:13 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name SeveralHarmoniesNoNoteWithoutAHarmony.ly SeveralHarmoniesNoNoteWithoutAHarmony.xml
% or, with short option names:
%     SeveralHarmoniesNoNoteWithoutAHarmony.ly SeveralHarmoniesNoNoteWithoutAHarmony.xml
...
\header {
  workCreditTypeTitle = "Several Harmonies No Note Without A Harmony"
  encodingDate        = "2023-02-27"
  software            = "MuseScore 3.6.2"
  title               = "Several Harmonies No Note Without A Harmony"
}
...
Part_POne_HARMONIES_Staff_HARMONIES_VoiceEleven = \chordmode {
  ...
  c4:m f8:m7 g:maj7 d4:m cis:aug/gis a2:m7
  \bar "|."
  s  | % 1
  \barNumberCheck #3
}
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \key c \major
  \numericTimeSignature \time 4/4
  \stemUp f'4 c'8 e' d'4 g'
  \stemDown  < a' c'' e'' > 2 \stemUp a'4
  \bar "|."
