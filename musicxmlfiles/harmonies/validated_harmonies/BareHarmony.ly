...
% Generated from "BareHarmony.xml"
% by xml2ly 0.9.76-dev (built on September 10, 2025)
% on Wednesday 2025-09-10 @ 17:30:04 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name BareHarmony.ly BareHarmony.xml
% or, with short option names:
%     BareHarmony.ly BareHarmony.xml
