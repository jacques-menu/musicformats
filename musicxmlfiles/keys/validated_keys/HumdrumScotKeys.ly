...
% Generated from "HumdrumScotKeys.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 09:33)
% on Thursday 2025-05-29 @ 14:52:47 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name HumdrumScotKeys.ly HumdrumScotKeys.xml
% or, with short option names:
%     HumdrumScotKeys.ly HumdrumScotKeys.xml
