...
% Generated from "TwoStaves.xml"
% on Wednesday 2025-05-28 @ 09:25:55 CEST
% by xml2ly v0.9.74 (built May 26, 2025 @ 16:51)

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name TwoStaves.ly TwoStaves.xml
% or, with short option names:
%     TwoStaves.ly TwoStaves.xml
