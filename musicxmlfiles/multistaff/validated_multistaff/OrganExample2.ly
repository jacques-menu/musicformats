...
% Generated from "OrganExample2.xml"
% by xml2ly v0.9.74-dev (built May 28, 2025 @ 17:13)
% on Wednesday 2025-05-28 @ 18:53:01 CEST

% The conversion command as supplied was: 
%  xml2ly -tpasses -auto-output-file-name -lilypond-run-date -lilypond-generation-infos OrganExample2.xml -tpim
% or, with long option names:
%  xml2ly -trace-passes -auto-output-file-name -lilypond-run-date -lilypond-generation-infos OrganExample2.xml -trace-positions-in-measures
...
\paper {
  ...
  oddFooterMarkup = \markup {
    ...
    \column {
      \fill-line {
        #(string-append
"Score generated from MusicXML data by xml2ly v0.9.74-dev (built May 28, 2025 @ 17:13) and LilyPond " (lilypond-version))
      }
