...
% Generated from "CrossStaffChordWithoutBeams.xml"
% on Wednesday 2025-05-28 @ 09:25:48 CEST
% by xml2ly v0.9.74 (built May 26, 2025 @ 16:51)

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name CrossStaffChordWithoutBeams.ly CrossStaffChordWithoutBeams.xml
% or, with short option names:
%     CrossStaffChordWithoutBeams.ly CrossStaffChordWithoutBeams.xml
...
\header {
  workCreditTypeTitle = "Cross-staves Chord Without Beams"
  miscellaneousField  = "Staff changes in a piano staff.
          ...
          the second staff."
  title               = "Cross-staves Chord Without Beams"
}
