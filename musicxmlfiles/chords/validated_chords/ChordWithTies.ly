...
% Generated from "ChordWithTies.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 15:56:44 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name ChordWithTies.ly ChordWithTies.xml
% or, with short option names:
%     ChordWithTies.ly ChordWithTies.xml
...
\header {
  movementTitle       = "Chord With Ties"
  encodingDate        = "2016-12-25"
  software            = "MuseScore 2.0.3.1"
  title               = "Chord With Ties"
}
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \key c \major
  \time 4/4
  \stemDown  < c'' e'' g'' bes''! > 8 -\p -\p -\p -! r e''2. ~  
  
   < a' c'' e'' ~  a'' > 2 -\f -\f -\f  < c'' e'' g'' >  -\staccato -_
}
