...
% Generated from "RestAfterAChord.xml"
% by xml2ly v0.9.75-dev (built May 30, 2025)
% on Tuesday 2025-06-03 @ 18:24:37 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name RestAfterAChord.ly RestAfterAChord.xml
% or, with short option names:
%     RestAfterAChord.ly RestAfterAChord.xml
...
\header {
  workCreditTypeTitle = "Rest After A Chord"
  title               = "Rest After A Chord"
}
