...
% Generated from "LetRingChord.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 15:56:45 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name LetRingChord.ly LetRingChord.xml
% or, with short option names:
%     LetRingChord.ly LetRingChord.xml
...
\header {
  workCreditTypeTitle = "Let-ring Chord"
  movementTitle       = "Let-ring Chord"
  encodingDate        = "2025-03-03"
  software            = "Dorico 5.1.81.2225"
  title               = "Let-ring Chord"
}
