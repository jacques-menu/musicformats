...
% Generated from "ChordInTupletLeft.xml"
% on Friday 2025-05-23 @ 18:30:13 CEST
% by xml2ly v0.9.74 (built May 23, 2025 @ 11:50)

% The conversion command as supplied was: 
%  xml2ly -auto-output-file-name -lilypond-run-date -lilypond-generation-infos ChordInTupletLeft.xml
% or, with short option names:
%      ChordInTupletLeft.xml
...
\header {
  movementTitle       = "Chord In Tuplet Left"
  encodingDate        = "2024-11-12"
  software            = "MuseScore 4.4.3"
  title               = "Chord In Tuplet Left"
}
...
\paper {
  ...
  oddFooterMarkup = \markup {
    ...
    \column {
      \fill-line {
        #(string-append
"Score generated from MusicXML data by xml2ly v0.9.74 (built May 23, 2025 @ 11:50) and LilyPond " (lilypond-version))
      }
