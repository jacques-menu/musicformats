...
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name ChordInTupletLeft.ly ChordInTupletLeft.xml
% or, with short option names:
%     ChordInTupletLeft.ly ChordInTupletLeft.xml
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \tuplet 3/2 {  \stemDown  < c'' g'' > 4 f'' e'' } r2
}
