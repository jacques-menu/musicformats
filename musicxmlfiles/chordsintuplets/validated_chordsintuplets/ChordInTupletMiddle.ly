...
% Generated from "ChordInTupletMiddle.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 15:58:29 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name ChordInTupletMiddle.ly ChordInTupletMiddle.xml
% or, with short option names:
%     ChordInTupletMiddle.ly ChordInTupletMiddle.xml
...
\header {
  movementTitle       = "Chord In Tuplet Middle"
  encodingDate        = "2024-11-12"
  software            = "MuseScore 4.4.3"
  title               = "Chord In Tuplet Middle"
}
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \tuplet 3/2 {  \stemDown g''4  < d'' f'' >  e'' } r2
}
