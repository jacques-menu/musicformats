...
% Generated from "ChordInTupletRight.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 15:58:30 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name ChordInTupletRight.ly ChordInTupletRight.xml
% or, with short option names:
%     ChordInTupletRight.ly ChordInTupletRight.xml
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \tuplet 3/2 {  \stemDown g''4 f''  < c'' e'' >  } r2
}
