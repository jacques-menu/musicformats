...
% Generated from "ATupletAndAPentolet.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 15:27:56 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name ATupletAndAPentolet.ly ATupletAndAPentolet.xml
% or, with short option names:
%     ATupletAndAPentolet.ly ATupletAndAPentolet.xml
