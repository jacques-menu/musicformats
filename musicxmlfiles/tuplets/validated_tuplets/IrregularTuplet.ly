...
% Generated from "IrregularTuplet.xml"
% by xml2ly 0.9.76-dev (built on September 10, 2025)
% on Tuesday 2025-09-16 @ 15:29:29 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name IrregularTuplet.ly IrregularTuplet.xml
% or, with short option names:
%     IrregularTuplet.ly IrregularTuplet.xml
...
\header {
  workCreditTypeTitle = "Irregular Tuplet"
  movementTitle       = "Irregular Tuplet"
  encodingDate        = "2016-09-24"
  software            = "Frescobaldi 2.18.1"
  title               = "Irregular Tuplet"
}
