...
% Generated from "TupletTest3.xml"
% by xml2ly 0.9.76-dev (built on September 10, 2025)
% on Tuesday 2025-09-16 @ 15:29:36 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name TupletTest3.ly TupletTest3.xml
% or, with short option names:
%     TupletTest3.ly TupletTest3.xml
