...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  %{ begin kMeasureKindOverFlowing, measure 1, % measureAccumulatedWholeNotesDuration: 2/1 whn %}
  ...
  \tuplet 7/5 {  %{ tupletNumber: 1, tupleFactor: 7/5, line 45 %}  c''8 c'' c'' }
  \once\override TupletBracket.bracket-visibility = ##t
  \once \override TupletNumber.text = #tuplet-number::calc-fraction-text
  \tuplet 7/5 {  %{ tupletNumber: 1, tupleFactor: 7/5, line 104 %}  c''4. c'' c'' }
