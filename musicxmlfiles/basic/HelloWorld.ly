...
% Generated by xml2ly v0.9.70 (January 10, 2024)
% on Tuesday 2024-01-16 @ 17:25:55 CET
% from "HelloWorld.xml"

% The conversion date was: Tuesday 2024-01-16 @ 17:25:55 CET

% The conversion command as supplied was: 
%  xml2ly -auto-output-file-name -lilypond-run-date -lilypond-generation-infos HelloWorld.xml -dlpsr -tlpsrvis
% or, with long option names:
%  xml2ly -auto-output-file-name -lilypond-run-date -lilypond-generation-infos HelloWorld.xml -display-lpsr -trace-lpsr-visitors
...
\paper {
  ...
  oddFooterMarkup = \markup {
    ...
    \column {
      \fill-line {
        #(string-append
"Score generated from MusicXML data by xml2ly v0.9.70 (January 10, 2024) and LilyPond " (lilypond-version))
      }
