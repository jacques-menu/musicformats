...
% Generated by xml2ly 0.9.72-beta-2 (March 22, 2025 - 14:42)
% on Thursday 2025-03-27 @ 17:52:55 CET
% from "LilyPondSkipAndBarCheckForEmptyMeasure.xml"

% The conversion date was: Thursday 2025-03-27 @ 17:52:55 CET

% The conversion command as supplied was: 
%  xml2ly -auto-output-file-name -lilypond-run-date -lilypond-generation-infos -auto-output-file-name -lilypond-run-date -lilypond-generation-infos LilyPondSkipAndBarCheckForEmptyMeasure.xml
% or, with short option names:
%         LilyPondSkipAndBarCheckForEmptyMeasure.xml
...
\paper {
  ...
  oddFooterMarkup = \markup {
    ...
    \column {
      \fill-line {
        #(string-append
"Score generated from MusicXML data by xml2ly 0.9.72-beta-2 (March 22, 2025 - 14:42) and LilyPond " (lilypond-version))
      }
