...
% Generated from "Waltzer.xml"
% by xml2ly v0.9.75-dev (built June 13, 2025)
% on Saturday 2025-06-14 @ 08:24:25 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name Waltzer.ly Waltzer.xml
% or, with short option names:
%     Waltzer.ly Waltzer.xml
