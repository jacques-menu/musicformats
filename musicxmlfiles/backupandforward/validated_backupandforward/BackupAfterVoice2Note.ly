...
% Generated from "BackupAfterVoice2Note.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 16:06:17 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name BackupAfterVoice2Note.ly BackupAfterVoice2Note.xml
% or, with short option names:
%     BackupAfterVoice2Note.ly BackupAfterVoice2Note.xml
