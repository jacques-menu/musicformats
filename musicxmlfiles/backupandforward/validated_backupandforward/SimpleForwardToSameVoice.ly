...
% Generated from "SimpleForwardToSameVoice.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 09:33)
% on Thursday 2025-05-29 @ 12:30:15 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name SimpleForwardToSameVoice.ly SimpleForwardToSameVoice.xml
% or, with short option names:
%     SimpleForwardToSameVoice.ly SimpleForwardToSameVoice.xml
...
\header {
  workCreditTypeTitle = "Simple Forward To Same Voice"
  title               = "Simple Forward To Same Voice"
}
