...
% Generated from "SyllableOnRest.xml"
% by xml2ly v2026.2 (built on June 02, 2026)
% on Tuesday 2026-06-02 @ 06:30:00 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name SyllableOnRest.ly SyllableOnRest.xml -lilypond-lyrics-durations-mode explicit
% or, with short option names:
%     SyllableOnRest.ly SyllableOnRest.xml explicit
...
\header {
  movementTitle       = "Syllable On Rest"
