...
% Generated from "EmptyMeasuresInLyrics.xml"
% by xml2ly v2026.2 (built on June 02, 2026)
% on Tuesday 2026-06-02 @ 06:29:50 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name EmptyMeasuresInLyrics.ly EmptyMeasuresInLyrics.xml -lilypond-lyrics-durations-mode explicit
% or, with short option names:
%     EmptyMeasuresInLyrics.ly EmptyMeasuresInLyrics.xml explicit
...
\header {
  workCreditTypeTitle = "Empty Measures In Lyrics"
  encodingDate        = "2023-11-17"
  composer            = "muz. Carlo Gesualdo da Venosa"
  software            = "MuseScore 4.1.1"
  title               = "Empty Measures In Lyrics"
}
