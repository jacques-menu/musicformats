...
% Generated from "SimpleExtendWithRest2.xml"
% by xml2ly v2026.2 (built on June 02, 2026)
% on Tuesday 2026-06-02 @ 06:29:54 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name SimpleExtendWithRest2.ly SimpleExtendWithRest2.xml -lilypond-lyrics-durations-mode explicit
% or, with short option names:
%     SimpleExtendWithRest2.ly SimpleExtendWithRest2.xml explicit
...
\header {
  movementTitle       = "Simple Extend With Rests 2"
  title               = "Simple Extend With Rests 2"
}
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  R2 \stemUp c'8 r e'4 ~  e'8 g'4 g'8 c'4 r
  \bar "|."
}
