...
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name TwoStanzas.ly TwoStanzas.xml -lilypond-lyrics-durations-mode explicit
% or, with short option names:
%     TwoStanzas.ly TwoStanzas.xml explicit
...
%  \set associatedVoice  = #"Part_POne_Staff_One_Voice_One#"
  \set ignoreMelismata = ##t
    "1.Sing"8 out8 all8 your8 prais4 -- es4 | % 5316
}
...
Part_POne_Staff_One_Voice_One_Stanza_Two = \lyricmode {
  ...
  \set associatedVoice  = #"Part_POne_Staff_One_Voice_One#"
  \set ignoreMelismata = ##t
    "2.For"8 the8 Son8 has8 ris4 -- en4 | % 5316
