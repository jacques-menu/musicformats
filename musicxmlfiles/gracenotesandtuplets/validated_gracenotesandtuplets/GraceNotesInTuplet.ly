...
% Generated from "GraceNotesInTuplet.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 16:03:04 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name GraceNotesInTuplet.ly GraceNotesInTuplet.xml
% or, with short option names:
%     GraceNotesInTuplet.ly GraceNotesInTuplet.xml
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \startStaff
  \stemDown \slurUp c''4 ~  ( \once \omit TupletBracket
  
  \once\override TupletBracket.direction = -1 % DOWN
  \tuplet 6/4 {  \stemUp c''16 [
  g' a' bes'! \grace { c''16 [  bes'16 ] } a'16 g' ]
  ) } f'4 r8 f'
}
