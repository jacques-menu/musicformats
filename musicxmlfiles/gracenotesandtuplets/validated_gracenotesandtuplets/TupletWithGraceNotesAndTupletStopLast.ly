...
% Generated from "TupletWithGraceNotesAndTupletStopLast.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 16:03:07 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name TupletWithGraceNotesAndTupletStopLast.ly TupletWithGraceNotesAndTupletStopLast.xml
% or, with short option names:
%     TupletWithGraceNotesAndTupletStopLast.ly TupletWithGraceNotesAndTupletStopLast.xml
...
\header {
  movementTitle       = "TupletWithGraceNotesAndTupletStopLast"
  encodingDate        = "2024-11-12"
  software            = "MuseScore 4.4.3"
  title               = "TupletWithGraceNotesAndTupletStopLast"
}
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \tuplet 3/2 {  \acciaccatura { fis''16 } \stemDown b''16 [
  \acciaccatura { fis''16 } b''16 b'' b''8 ]
  }
  \bar "|."
