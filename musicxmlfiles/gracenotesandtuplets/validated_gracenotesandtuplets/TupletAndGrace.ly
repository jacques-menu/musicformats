...
% Generated from "TupletAndGrace.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 13:04)
% on Thursday 2025-05-29 @ 16:03:05 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name TupletAndGrace.ly TupletAndGrace.xml
% or, with short option names:
%     TupletAndGrace.ly TupletAndGrace.xml
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \once\override TupletBracket.bracket-visibility = ##t
  \tuplet 3/2 {  \acciaccatura { fis''16 } b''16 [
