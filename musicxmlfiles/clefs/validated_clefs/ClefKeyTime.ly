...
% Generated from "ClefKeyTime.xml"
% by xml2ly v0.9.74-dev (built May 29, 2025 @ 09:33)
% on Thursday 2025-05-29 @ 14:51:37 CEST

% The conversion command as supplied was: 
%  xml2ly -lilypond-run-date -lilypond-generation-infos -output-file-name ClefKeyTime.ly ClefKeyTime.xml
% or, with short option names:
%     ClefKeyTime.ly ClefKeyTime.xml
...
\header {
  workCreditTypeTitle = "Clef Key Time"
  encodingDate        = "2017-04-04"
