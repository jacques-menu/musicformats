                    ...
                    insiderOahHandler)
{
  ...
  msdl2guidoRegularHandler* o = new
...
void msdl2guidoRegularHandler::createDisplayRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createFilesRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createOahRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createPresentationRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createPartsRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createStavesRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createVoicesRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createClefsRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createKeysRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createTimesRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createMeasuresRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createNotesRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::creatBeamsRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createArticulationsRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createOrnamentsRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createGraceNotesRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createChordsRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createSlursRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createLigaturesRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createDynamicRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createWedgesRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createTupletsRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createLyricsRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createHarmoniesRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createFiguredBassRegularGroup ()
{
  // group
...
void msdl2guidoRegularHandler::createOutputRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void msdl2guidoRegularHandler::print (std::ostream& os) const
{
  const int fieldWidth = 27;

  os <<
    "msdl2guidoRegularHandler '" << fHandlerHeader << "':" <<
    std::endl;
...
std::ostream& operator << (std::ostream& os, const S_msdl2guidoRegularHandler& elt)
{
  if (elt) {
    elt->print (os);
  }
