...
S_msdl2lilypondRegularHandler msdl2lilypondRegularHandler::create (
                    ...
                    insiderOahHandler)
{
  ...
  msdl2lilypondRegularHandler* obj = new
...
msdl2lilypondRegularHandler::msdl2lilypondRegularHandler (
  const std::string&     serviceName,
  const std::string&     handlerHeader,
  S_msdl2lilypondInsiderHandler
                    insiderOahHandler)
...
void msdl2lilypondRegularHandler::createOahRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createInformationsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createDisplayRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createPartsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createStavesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createVoicesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createTranspositionsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createClefsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createKeysRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createTimesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createMeasuresRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createRestsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createNotesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createArticulationsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createOrnamentsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createGraceNotesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createChordsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createTiesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createLigaturesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createDynamicRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createWedgesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createTupletsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createStringsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createTablaturesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createHarmoniesRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createFiguredBassRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createLyricsRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createBookRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createPaperRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createLayoutRegularGroup ()
{
  // group
...
void msdl2lilypondRegularHandler::createOutputRegularGroup ()
{
  // group
  ...
  registerAtomInRegularSubgroup ("msdl2lilypond-infos", subGroup);
...
void msdl2lilypondRegularHandler::createMidiRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void msdl2lilypondRegularHandler::print (std::ostream& os) const
{
  const int fieldWidth = 27;

  os <<
    "msdl2lilypondRegularHandler '" << fHandlerHeader << "':" <<
    std::endl;
...
std::ostream& operator << (std::ostream& os, const S_msdl2lilypondRegularHandler& elt)
{
  if (elt) {
    elt->print (os);
  }
