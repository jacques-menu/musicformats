                    ...
                    insiderOahHandler)
{
  ...
  msr2brailleRegularHandler* obj = new
...
void msr2brailleRegularHandler::createDynamicRegularGroup ()
{
  // group
...
void msr2brailleRegularHandler::createFiguredBassRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void msr2brailleRegularHandler::checkOptionsAndArguments () const
{
#ifdef MF_TRACE_IS_ENABLED
  if (gEarlyOptions.getTraceEarlyOptions ()) {
    std::stringstream ss;
...
//______________________________________________________________________________
void msr2brailleRegularHandler::print (std::ostream& os) const
{
...
std::ostream& operator << (std::ostream& os, const S_msr2brailleRegularHandler& elt)
{
  if (elt) {
    elt->print (os);
  }
