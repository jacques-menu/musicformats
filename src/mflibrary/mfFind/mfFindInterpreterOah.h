...
#ifndef ___mfFindInterpreterOah___
#define ___mfFindInterpreterOah___
...
//______________________________________________________________________________
class EXP mfFindInterpreterOahGroup : public oahGroup
{
  public:
    ...
    static SMARTP<mfFindInterpreterOahGroup> create ();
  ...
  private:
    ...
    void                  initializemfFindInterpreterOahGroup ();
  ...
  protected:
    ...
    // ------------------------------------------------------
                          ...
                          mfFindInterpreterOahGroup ();

    virtual               ~mfFindInterpreterOahGroup ();
...
// JMI    void                  initializemfFindInterpretertracingOah ();
#endif // MF_TRACE_IS_ENABLED

    void                  initializemfFindOptions ();
  ...
  public:
    ...
    void                  printmfFindInterpreterOahHelp ();

    void                  printmfFindInterpreterOahValues (
                            int fieldWidth);
...
typedef SMARTP<mfFindInterpreterOahGroup> S_mfFindInterpreterOahGroup;
EXP std::ostream& operator<< (std::ostream& os, const S_mfFindInterpreterOahGroup& elt);

EXP extern S_mfFindInterpreterOahGroup gGlobalmfFindInterpreterOahGroup;

//______________________________________________________________________________
EXP S_mfFindInterpreterOahGroup createGlobalmfFindInterpreterOahGroup ();


}


#endif // ___mfFindInterpreterOah___
