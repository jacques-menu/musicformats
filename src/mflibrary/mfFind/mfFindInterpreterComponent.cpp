...
//______________________________________________________________________________
S_mfcConverterComponent createmfFindInterpreterComponent ()
{
    ...
    pConverterComponent->
      appendVersionDescrToComponent (
        mfcVersionDescr::create (
          ...
          "March 9, 2022",
          list<std::string> {
            "Finalized the syntax and semantics of mfFind, added '-input' option"
          }
      ));
