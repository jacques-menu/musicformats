...
#ifndef ___mfFilterInterpreterOah___
#define ___mfFilterInterpreterOah___
...
//______________________________________________________________________________
class EXP mfFilterInterpreterOahGroup : public oahGroup
{
  public:
    ...
    static SMARTP<mfFilterInterpreterOahGroup> create ();
  ...
  private:
    ...
    void                  initializemfFilterInterpreterOahGroup ();
  ...
  protected:
    ...
    // ------------------------------------------------------
                          ...
                          mfFilterInterpreterOahGroup ();

    virtual               ~mfFilterInterpreterOahGroup ();
...
// JMI    void                  initializemfFilterInterpretertracingOah ();
#endif // MF_TRACE_IS_ENABLED

    void                  initializemfFilterOptions ();
  ...
  public:
    ...
    void                  printmfFilterInterpreterOahHelp ();

    void                  printmfFilterInterpreterOahValues (
                            int fieldWidth);
...
typedef SMARTP<mfFilterInterpreterOahGroup> S_mfFilterInterpreterOahGroup;
EXP std::ostream& operator<< (std::ostream& os, const S_mfFilterInterpreterOahGroup& elt);

EXP extern S_mfFilterInterpreterOahGroup gGlobalmfFilterInterpreterOahGroup;

//______________________________________________________________________________
EXP S_mfFilterInterpreterOahGroup createGlobalmfFilterInterpreterOahGroup ();


}


#endif // ___mfFilterInterpreterOah___
