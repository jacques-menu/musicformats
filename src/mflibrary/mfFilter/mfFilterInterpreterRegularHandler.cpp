...
#include "mfFilterInterpreterRegularHandler.h"
...
S_mfFilterInterpreterRegularHandler mfFilterInterpreterRegularHandler::create (
                     ...
                     insiderOahHandler)
{
  ...
  mfFilterInterpreterRegularHandler* obj = new
...
mfFilterInterpreterRegularHandler::mfFilterInterpreterRegularHandler (
  const std::string& serviceName,
  const std::string& handlerHeader,
  S_mfFilterInterpreterInsiderHandler
                     insiderOahHandler)
...
void mfFilterInterpreterRegularHandler::createRegularHandlerGroups ()
{
#ifdef MF_TRACE_IS_ENABLED
  if (gEarlyOptions.getEarlyTraceOah ()) {
    gLog <<
  ...
  createmfFilterRegularUserGroup ();
  createmfFilterRegularMaintainanceGroup ();
...
void mfFilterInterpreterRegularHandler::createInformationsRegularGroup ()
{
  // group
...
void mfFilterInterpreterRegularHandler::createmfFilterRegularUserGroup ()
{
  // group
  ...
  S_oahGroup
    group =
      oahGroup::create (
        "mfFilter group",
        "help-mfFilter-user-group", "hmfFilter-user-group",
        "",
        oahElementVisibilityKind::kElementVisibilityWhole);
  appendGroupToRegulalHandler (group);
...
void mfFilterInterpreterRegularHandler::createmfFilterRegularMaintainanceGroup ()
{
  // group
  ...
  S_oahGroup
    group =
      oahGroup::create (
        "mfFilter group",
        "help-mfFilter-maintainance-group", "hmfFilter--maintainance-group",
        "",
        oahElementVisibilityKind::kElementVisibilityWhole);
  appendGroupToRegulalHandler (group);
...
void mfFilterInterpreterRegularHandler::createOahRegularGroup ()
{
  // group
...
void mfFilterInterpreterRegularHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void mfFilterInterpreterRegularHandler::checkOptionsAndArguments () const
{
#ifdef MF_TRACE_IS_ENABLED
  if (gEarlyOptions.getEarlyTraceOah ()) {
    gLog <<
...
//______________________________________________________________________________
void mfFilterInterpreterRegularHandler::print (std::ostream& os) const
{
  const int fieldWidth = 27;

  os <<
    "mfFilterInterpreterRegularHandler '" << fHandlerHeader << "':" <<
    endl;
...
std::ostream& operator<< (std::ostream& os, const S_mfFilterInterpreterRegularHandler& elt)
{
  if (elt) {
    elt->print (os);
  }
