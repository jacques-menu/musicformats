...
//______________________________________________________________________________
S_mfcConverterComponent createmfFilterInterpreterComponent ()
{
  ...
  if (gEarlyOptions.getEarlyTraceComponents ()) {
    gLog <<
      "Creating the mfFilter component" <<
      endl;
  }
    ...
    pConverterComponent->
      appendVersionDescrToComponent (
        mfcVersionDescr::create (
          ...
          "March 9, 2022",
          list<std::string> {
            "Created the mfFilter component"
          }
      ));
    ...
    pConverterComponent->
      appendVersionDescrToComponent (
        mfcVersionDescr::create (
          ...
          "March 9, 2022",
          list<std::string> {
            "Finalized the syntax and semantics of mfFilter, added '-input' option"
          }
      ));
