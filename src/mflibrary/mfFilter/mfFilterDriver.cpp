...
// void mfFilterDriver::expressionsStackPush (
...
// S_mfFilterExpression mfFilterDriver::expressionsStackTop () const
// {
//   // sanity check
//   mfAssert (
//     __FILE__, __LINE__,
...
// void mfFilterDriver::displayExpressionsStack (
...
//     ++gIndenter;
//
//     for (S_mfFilterExpression expression : fExpressionsStack) {
//       gLog << expression;
//     } // for
//
//     --gIndenter;
...
//   if (gGlobalmfFilterInterpreterOahGroup->getTraceExpressions ()) {
//     gLog <<
//       "====> fExpressionsStack:" <<
//       endl;
//
...
S_mfFilterExpression mfFilterDriver::expressionsStackTop ()
{
  // sanity check
  mfAssert (
    __FILE__, __LINE__,
...
void mfFilterDriver::expressionsStackPop (
  const std::string& context)
{
  // sanity check
  mfAssert (
