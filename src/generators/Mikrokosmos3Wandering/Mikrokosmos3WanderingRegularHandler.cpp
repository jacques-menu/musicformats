...
void Mikrokosmos3WanderingRegularHandler::createDisplayRegularGroup ()
{
  // group
...
void Mikrokosmos3WanderingRegularHandler::createDynamicRegularGroup ()
{
  // group
...
void Mikrokosmos3WanderingRegularHandler::createFiguredBassRegularGroup ()
{
  // group
