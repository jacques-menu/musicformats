...
// std::string msrNote::tupletNoteGraphicNotesDurationpitchAndOctaveAsString ( // JMI v0.9.66
...
std::string msrNote::pitchAndOctaveAsString () const
{
  std::stringstream ss;
...
std::string msrNote::noteForPrintAsSting () const
{
  std::stringstream ss;
