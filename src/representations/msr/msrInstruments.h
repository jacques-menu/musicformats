...
class EXP msrStringTuning : public msrMeasureElement
{
  ...
  public:
    ...
    void                  getMeasureElementUpLinkToMeasure (
                            ...
                            { upLinkToMeasure = getStringTuningUpLinkToMeasure (); }
...
class EXP msrScordatura : public msrMeasureElement
{
  ...
  public:
    ...
    void                  getMeasureElementUpLinkToMeasure (
                            S_msrMeasure& upLinkToMeasure) const override
                            { upLinkToMeasure = getScordaturaUpLinkToMeasure (); }
...
class EXP msrAccordionRegistration : public msrMeasureElement
{
  ...
  public:
    ...
    void                  getMeasureElementUpLinkToMeasure (
                            S_msrMeasure& upLinkToMeasure) const override
                            { upLinkToMeasure = getAccordionRegistrationUpLinkToMeasure (); }
...
class EXP msrHarpPedalsTuning : public msrMeasureElement
{
  ...
  public:
    ...
    void                  getMeasureElementUpLinkToMeasure (
                            S_msrMeasure& upLinkToMeasure) const override
                            { upLinkToMeasure = getHarpPedalsTuningUpLinkToMeasure (); }
...
class EXP msrPedal : public msrMeasureElement
{
  ...
  public:
    ...
    void                  getMeasureElementUpLinkToMeasure (
                            S_msrMeasure& upLinkToMeasure) const override
                            { upLinkToMeasure = getPedalUpLinkToMeasure (); }
...
class EXP msrDamp : public msrMeasureElement
{
  ...
  public:
    ...
    void                  getMeasureElementUpLinkToMeasure (
                            S_msrMeasure& upLinkToMeasure) const override
                            { upLinkToMeasure = getDampUpLinkToMeasure (); }
...
class EXP msrDampAll : public msrMeasureElement
{
  ...
  public:
    ...
    void                  getMeasureElementUpLinkToMeasure (
                            S_msrMeasure& upLinkToMeasure) const override
                            { upLinkToMeasure = getDampAllUpLinkToMeasure (); }
