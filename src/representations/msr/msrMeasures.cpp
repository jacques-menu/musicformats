  ...
  const S_msrSegment& containingSegment)
{
  ...
  deepClone->fFullMeasureWholeNotes =
    fFullMeasureWholeNotes;

  deepClone->fMeasureWholeNotes = // JMI ???
    fMeasureWholeNotes;
...
/* JMI
  // lengthes
  measureCopy->fFullMeasureWholeNotes =
    fFullMeasureWholeNotes;

  measureCopy->fMeasureWholeNotes =
    fMeasureWholeNotes;
  ...
  if (measureElementsListSize) {
    ...
    for ( ; ; ) {
      ...
      if (measurePosition == currentMeasurePosition) {
        ...
        msrInternalErrorWithMeasureInfo (
...
std::string msrMeasure::fullMeasureWholeNotesAsMsrString ()
{
  return
...
void msrMeasure::setFullMeasureWholeNotes (
...
// #endif // MF_SANITY_CHECKS_ARE_ENABLED
  ...
  msrWholeNotes
    newMeasureWholeNotes =
      fMeasureWholeNotes + wholeNotesDelta;
  ...
  if (wholeNotesDelta == msrWholeNotes (7, 8)) abort ();
...
std::string msrMeasure::measureWholeNotesAsMsrString ()
{
  return
    wholeNotesAsMsrString (
      fInputLineNumber,
...
void msrMeasure::setFullMeasureWholeNotesFromTimeSignature (
  const S_msrTimeSignature& timeSignature)
{
#ifdef MF_SANITY_CHECKS_ARE_ENABLED
  // sanity check
    ...
    case msrTimeSignatureSymbolKind::kTimeSignatureSymbolNone:
      {
        ...
        if (gTraceOahGroup->getTraceTimeSignatures ()) {
          ...
          ss <<
            ...
            "\"" <<
            " has " <<
            fFullMeasureWholeNotes.asString () <<
...
//  msrInternalErrorWithMeasureInfo ( // JMI v0.9.66
    msrInternalWarningWithMeasureInfo (
      gServiceRunData->getInputSourceName (),
      inputLineNumber,
  //    __FILE__, __LINE__,
      ss.str (),
...
//       std::endl << std::endl;
    ...
    msrInternalErrorWithMeasureInfo (
//     msrInternalWarningWithMeasureInfo ( // JMI v0.9.67
      gServiceRunData->getInputSourceName (),
      inputLineNumber,
      __FILE__, __LINE__,
      ss.str (),
...
/*
 // JMI   msrInternalErrorWithMeasureInfo (
    msrInternalWarningWithMeasureInfo (
      gServiceRunData->getInputSourceName (),
      fInputLineNumber,
  //    __FILE__, __LINE__,
...
// JMI ???
  ...
  if (gTraceOahGroup->getTraceMeasures ()) {
    ...
    ss <<
      ...
      this->asShortString () <<
      ", fullMeasureWholeNotes: " << fFullMeasureWholeNotes.asString () <<
      "', measureWholeNotes: " << fMeasureWholeNotes.asString () <<
  ...
  if (fMeasureWholeNotes.getNumerator () == 0) {
    // empty measure
      handleEmptyMeasure (
        inputLineNumber,
        voice);
  ...
  else if (fMeasureWholeNotes == fFullMeasureWholeNotes) {
    ...
    // set measure kind
    if (fMeasureWholeNotes < fFullMeasureWholeNotes) {
    ...
    else { // fMeasureWholeNotes > fFullMeasureWholeNotes
  ...
  const msrWholeNotes& newWholeNotesSinceLastRegularMeasureEnd)
{
  ...
  if (fMeasureIsFirstInVoice) {
    ...
    gLog <<
      "=====> handleIncompleteMeasure() 2 -- scoreNumberOfMeasures: " <<
      scoreNumberOfMeasures <<
      std::endl;
...
*/
  ...
  if (fMeasureKind != originalMeasureMeasureKind) {
   ...
   //   msrInternalErrorWithMeasureInfo ( // JMI
      msrInternalWarningWithMeasureInfo (
        gServiceRunData->getInputSourceName (),
        inputLineNumber,
   //      __FILE__, __LINE__,
