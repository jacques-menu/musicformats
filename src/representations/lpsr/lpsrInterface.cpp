  ...
  S_lpsrOahGroup    lpsrOpts)
{
  ...
  gLogStream <<
    ...
    endl <<
    gTab <<
    "Pass (optional): displaying the LPSR as text" <<
    endl <<
    separator <<
    endl << endl <<
    theLpsrScore <<
  ...
  S_lpsrOahGroup    lpsrOpts)
{
  ...
  gLogStream <<
    ...
    endl <<
    gTab <<
    "Pass (optional): displaying the LPSR as text, short version" <<
    endl <<
    separator <<
    endl << endl;
  ...
  S_lpsrOahGroup    lpsrOpts)
{
  ...
  gLogStream <<
    ...
    endl <<
    gTab <<
    "Pass (optional): displaying the LPSR as text, full version" <<
    endl <<
    separator <<
    endl << endl;
