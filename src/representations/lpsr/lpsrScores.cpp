    ...
    : lpsrElement (inputLineNumber)
{
  ...
  if (gGlobalLpsr2lilypondOahGroup->getXml2lyInfos ()) {
    // create the 'generated from' comment
    {
    ...
    // create the 'generated on' comment
    {
      std::stringstream ss;
...
void lpsrScore::browseData (basevisitor* v)
{
  ...
  if (fGeneratedByComment) {
    // browse the 'generated by' comment
    msrBrowser<lpsrComment> browser (v);
    browser.browse (*fGeneratedByComment);
  }
  if (fGeneratedOnComment) {
    // browse the 'generated on' comment
    msrBrowser<lpsrComment> browser (v);
    browser.browse (*fGeneratedOnComment);
  }
