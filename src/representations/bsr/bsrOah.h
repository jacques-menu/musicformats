...
class EXP bsrOahGroup : public oahGroup
{
  ...
  public:
    ...
    void                  setDisplayBsrFirst ()
                              { fDisplayBsrFirst  = true; }
    Bool                  getDisplayBsrFirst  () const
                              { return fDisplayBsrFirst ; }

    void                  setDisplayBsrFirstShort ()
                              { fDisplayBsrFirstShort = true; }
    Bool                  getDisplayBsrFirstShort () const
                              { return fDisplayBsrFirstShort; }

    Bool                  getDisplayBsrFirstDetails () const
                              { return fDisplayBsrFirstDetails; }

    void                  setDisplayBsrSecond ()
                              { fDisplayBsrSecond  = true; }
    Bool                  getDisplayBsrSecond  () const
                              { return fDisplayBsrSecond ; }

    void                  setDisplayBsrSecondShort ()
                              { fDisplayBsrSecondShort = true; }
    Bool                  getDisplayBsrSecondShort () const
                              { return fDisplayBsrSecondShort; }

    Bool                  getDisplayBsrSecondDetails () const
                              { return fDisplayBsrSecondDetails; }

    Bool                  getDisplayBsr () const
                              {
                                return
                                  fDisplayBsrFirst || fDisplayBsrSecond;
                              }
  ...
  private:
    ...
    Bool                  fDisplayBsrFirst;
    Bool                  fDisplayBsrFirstShort;
    Bool                  fDisplayBsrFirstDetails;

    Bool                  fDisplayBsrSecond;
    Bool                  fDisplayBsrSecondShort;
    Bool                  fDisplayBsrSecondDetails;
