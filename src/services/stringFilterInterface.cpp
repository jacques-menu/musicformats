...
//     std::endl;
  ...
  // register stringfilter as current service
  // ------------------------------------------------------

  setGlobalService (mfServiceKind::kMfService_stringfilter);
  ...
  try {
    // create a stringfilter insider OAH handler
    // ------------------------------------------------------
...
//           oahHandlerUsedThruKind::kHandlerUsedThruArgcArgv);
    ...
    if (insiderOption) {
      // use the insider stringfilter OAH handler
      handler = insiderOahHandler;
    }
    else {
      // create a regular stringfilter OAH handler
      handler =
