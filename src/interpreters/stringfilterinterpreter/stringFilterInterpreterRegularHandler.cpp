...
S_stringFilterInterpreterRegularHandler stringFilterInterpreterRegularHandler::create (
                     ...
                     insiderOahHandler)
{
  ...
  stringFilterInterpreterRegularHandler* obj = new
...
stringFilterInterpreterRegularHandler::stringFilterInterpreterRegularHandler (
  const std::string& serviceName,
  const std::string& handlerHeader,
  S_stringFilterInterpreterInsiderHandler
                     insiderOahHandler)
...
void stringFilterInterpreterRegularHandler::createRegularHandlerGroups ()
{
#ifdef MF_TRACE_IS_ENABLED
  if (gEarlyOptions.getEarlyTraceOah ()) {
    gLog <<
  ...
  createstringFilterRegularUserGroup ();
  createstringFilterRegularMaintainanceGroup ();
...
void stringFilterInterpreterRegularHandler::createInformationsRegularGroup ()
{
  // group
...
void stringFilterInterpreterRegularHandler::createstringFilterRegularUserGroup ()
{
  // group
  ...
  S_oahGroup
    group =
      oahGroup::create (
        "stringFilter group",
        "help-stringFilter-user-group", "hstringFilter-user-group",
        "",
        oahElementVisibilityKind::kElementVisibilityWhole);
  appendGroupToRegulalHandler (group);
...
void stringFilterInterpreterRegularHandler::createstringFilterRegularMaintainanceGroup ()
{
  // group
  ...
  S_oahGroup
    group =
      oahGroup::create (
        "stringFilter group",
        "help-stringFilter-maintainance-group", "hstringFilter--maintainance-group",
        "",
        oahElementVisibilityKind::kElementVisibilityWhole);
  appendGroupToRegulalHandler (group);
...
void stringFilterInterpreterRegularHandler::createOahRegularGroup ()
{
  // group
...
void stringFilterInterpreterRegularHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void stringFilterInterpreterRegularHandler::checkOptionsAndArguments () const
{
#ifdef MF_TRACE_IS_ENABLED
  if (gEarlyOptions.getEarlyTraceOah ()) {
    gLog <<
...
//______________________________________________________________________________
void stringFilterInterpreterRegularHandler::print (std::ostream& os) const
{
  const int fieldWidth = 27;

  os <<
    "stringFilterInterpreterRegularHandler '" << fHandlerHeader << "':" <<
    endl;
...
std::ostream& operator<< (std::ostream& os, const S_stringFilterInterpreterRegularHandler& elt)
{
  if (elt) {
    elt->print (os);
  }
