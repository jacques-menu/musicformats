...
// A handy shortcut to the location held by the stringFilterDriver
stringfilter::location& loc = drv.getScannerLocationNonConst ();
...
void stringFilterDriver::scanBegin ()
{
