...
stringFilterDriver::stringFilterDriver ()
{
  // get the script source name
//   if (fScriptName == "-") {
//     // stringFilter data comes from standard input
...
//
//   else {
//     // stringFilter data comes from a file
// #ifdef MF_TRACE_IS_ENABLED
//     if (gEarlyOptions.getEarlyTraceOah ()) {
//       gLog <<
...
// void stringFilterDriver::expressionsStackPush (
...
// S_stringFilterExpression stringFilterDriver::expressionsStackTop () const
// {
//   // sanity check
//   mfAssert (
//     __FILE__, __LINE__,
...
// void stringFilterDriver::displayExpressionsStack (
...
//     ++gIndenter;
//
//     for (S_stringFilterExpression expression : fExpressionsStack) {
//       gLog << expression;
//     } // for
//
//     --gIndenter;
...
int stringFilterDriver::parseInput_Pass1 ()
{
  ...
  // do the parsing
  stringfilter::parser theParser (*this);
...
//   if (gGlobalstringFilterInterpreterOahGroup->getTraceExpressions ()) {
//     gLog <<
//       "====> fExpressionsStack:" <<
//       endl;
//
...
// }
//
// S_stringFilterExpression stringFilterDriver::expressionsStackTop ()
// {
//   // sanity check
//   mfAssert (
//     __FILE__, __LINE__,
...
// }
//
// void stringFilterDriver::expressionsStackPop (
//   const std::string& context)
// {
//   // sanity check
//   mfAssert (
...
//_______________________________________________________________________________
mfMusicformatsErrorKind stringFilterDriver::launchstringFilterService_Pass2 ()
{
