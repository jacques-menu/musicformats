...
S_stringMatcherInterpreterRegularHandler stringMatcherInterpreterRegularHandler::create (
                     ...
                     insiderOahHandler)
{
  ...
  stringMatcherInterpreterRegularHandler* obj = new
...
stringMatcherInterpreterRegularHandler::stringMatcherInterpreterRegularHandler (
  const std::string& serviceName,
  const std::string& handlerHeader,
  S_stringMatcherInterpreterInsiderHandler
                     insiderOahHandler)
...
void stringMatcherInterpreterRegularHandler::createRegularHandlerGroups ()
{
#ifdef MF_TRACE_IS_ENABLED
  if (gEarlyOptions.getEarlyTraceOah ()) {
    gLog <<
  ...
  createstringMatcherRegularUserGroup ();
  createstringMatcherRegularMaintainanceGroup ();
...
void stringMatcherInterpreterRegularHandler::createInformationsRegularGroup ()
{
  // group
...
void stringMatcherInterpreterRegularHandler::createstringMatcherRegularUserGroup ()
{
  // group
  ...
  S_oahGroup
    group =
      oahGroup::create (
        "stringMatcher group",
        "help-stringMatcher-user-group", "hstringMatcher-user-group",
        "",
        oahElementVisibilityKind::kElementVisibilityWhole);
  appendGroupToRegulalHandler (group);
...
void stringMatcherInterpreterRegularHandler::createstringMatcherRegularMaintainanceGroup ()
{
  // group
  ...
  S_oahGroup
    group =
      oahGroup::create (
        "stringMatcher group",
        "help-stringMatcher-maintainance-group", "hstringMatcher--maintainance-group",
        "",
        oahElementVisibilityKind::kElementVisibilityWhole);
  appendGroupToRegulalHandler (group);
...
void stringMatcherInterpreterRegularHandler::createOahRegularGroup ()
{
  // group
...
void stringMatcherInterpreterRegularHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void stringMatcherInterpreterRegularHandler::checkOptionsAndArguments () const
{
#ifdef MF_TRACE_IS_ENABLED
  if (gEarlyOptions.getEarlyTraceOah ()) {
    gLog <<
...
//______________________________________________________________________________
void stringMatcherInterpreterRegularHandler::print (std::ostream& os) const
{
  const int fieldWidth = 27;

  os <<
    "stringMatcherInterpreterRegularHandler '" << fHandlerHeader << "':" <<
    endl;
...
std::ostream& operator<< (std::ostream& os, const S_stringMatcherInterpreterRegularHandler& elt)
{
  if (elt) {
    elt->print (os);
  }
