...
void mfslInterpreterInsiderHandler::initializeHandlerMultiComponent ()
{
  ...
  fHandlerMultiComponent =
    createmfslInterpreterConverterComponent ();
}
...
void mfslInterpreterInsiderHandler::createTheMfslInterpreterPrefixes ()
{
  ...
  if (gGlobalOahEarlyOptions.getEarlyTracingOah ()) {
    gLogStream <<
      "Creating the mfslInterpreter prefixes in \"" <<
      fHandlerHeader <<
      "\"" <<
      endl;
  }
...
// JMI
  ...
  // create the mfslInterpreter OAH group
  appendGroupToHandler (
    createGlobalMfslInterpreterOahGroup ());

  // create the mfslInterpreter insider OAH group
  appendGroupToHandler (
...
S_mfslInterpreterInsiderOahGroup createGlobalMfslInterpreterInsiderOahGroup ()
{
  ...
  if (gGlobalOahEarlyOptions.getEarlyTracingOah ()) {
    gLogStream <<
      "Creating global mfslInterpreter insider OAH group" <<
      endl;
  }
#endif
