  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_COMMA = 8,                             // ","
        S_STAR = 9,                              // "*"
        S_LEFT_PARENTHESIS = 10,                 // "("
        S_RIGHT_PARENTHESIS = 11,                // ")"
        S_TOOL = 12,                             // "tool"
        S_INPUT = 13,                            // "input"
        S_CHOICE = 14,                           // "choice"
        S_SET = 15,                              // "set"
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOK_LEFT_PARENTHESIS, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_RIGHT_PARENTHESIS, std::move (l));
      }
#else
      static
      symbol_type
