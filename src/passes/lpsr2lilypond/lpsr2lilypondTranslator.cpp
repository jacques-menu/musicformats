...
void lpsr2lilypondTranslator::initializeLilypondUsefulFragments ()
{
  ...
  cLilypondSingleUnderscore = "_ ";
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondStructure ()) {
    cLilypondSingleUnderscore +=
      "%{ cLilypondSingleUnderscore %} ";
  }
  cLilypondDoubleUnderscore = "__ ";
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondStructure ()) {
  ...
  if (! gGlobalLpsr2lilypondOahGroup->getNoLilypondLyrics ()) {
    ...
    switch (gGlobalLpsr2lilypondOahGroup->getLyricsDurationsKind ()) {
      case lpsrLyricsDurationsKind::kLyricsDurationsAutomatic:
        ...
        fLilypondCodeStream <<
          cLilypondLyricsTo << "\"" <<
          elt->getVoice ()->getVoicePathLikeName () <<
          "\" { " <<
...
//       std::endl;
    ...
    fGenerateOngoingNonEmptyStanza =
      true ||
      ! fOnGoingVoice; // JMI 2026.2
//         &&
//       elt->getStanzaContainsText ();
    ...
    if (fGenerateOngoingNonEmptyStanza) {
      ...
      fLilypondCodeStream <<
        ...
        " lyrics durations mode" <<
        std::endl;

      switch (gGlobalLpsr2lilypondOahGroup->getLyricsDurationsKind ()) {
        case lpsrLyricsDurationsKind::kLyricsDurationsAutomatic:
          // no \lyricsto in that case, LilyPond takes care
          // of associating the notes and their syllables
          fLilypondCodeStream <<
...
//     gLog << "fGenerateOngoingNonEmptyStanza: " << fGenerateOngoingNonEmptyStanza << std::endl;
    ...
    if (fGenerateOngoingNonEmptyStanza) { // JMI 0.9.73 2026.2
  ...
  const S_msrSyllable& syllable)
{
  ...
  fLilypondCodeStream << std::left <<
    std::setw (fieldWidth) <<
    "getInputLineNumber" << ": " << syllable->getInputLineNumber () <<
    std::endl;
    ...
    case lpsrLyricsDurationsKind::kLyricsDurationsAutomatic:
      {
        ...
        handleLyricExtenderIfAnyAutomaticallySyllableSingle (
          syllable);
      }
      break;
    ...
    case lpsrLyricsDurationsKind::kLyricsDurationsExplicit:
      {
        ...
        handleLyricExtenderIfAnyExplicitlySyllableSingle (
          syllable);
      }
      break;
  } // switch
  ...
  const S_msrSyllable& syllable)
{
  switch (gGlobalLpsr2lilypondOahGroup->getLyricsDurationsKind ()) {
    case lpsrLyricsDurationsKind::kLyricsDurationsAutomatic:
      ...
      handleLyricExtenderIfAnyAutomaticallySyllableBegin (
        syllable);
      break;
    ...
    case lpsrLyricsDurationsKind::kLyricsDurationsExplicit:
      ...
      handleLyricExtenderIfAnyExplicitlySyllableBegin (
        syllable);
      break;
  } // switch
}
...
//           cLilypondSkip;
        ...
        handleLyricExtenderIfAnyAutomaticallySyllableMiddle_kSyllableSkipOnRegularNote (
          syllable);
//         fLilypondCodeStream <<
//           cLilypondSingleUnderscore;
      break;
    ...
    case lpsrLyricsDurationsKind::kLyricsDurationsExplicit:
      ...
      handleLyricExtenderIfAnyExplicitlySyllableMiddle_kSyllableSkipOnRegularNote ( // KRAKRA
//       handleLyricExtenderIfAnyExplicitlySyllableMiddle (
        syllable);
//       fLilypondCodeStream <<
//         cLilypondSingleUnderscore;
...
//   generateCodeBeforeSyllableIfRelevant (syllable);
  ...
  switch (syllable->getSyllableKind ()) {
    ...
    // ----------------------------------------------------
      generateLilypondSyllableSkipOnRegularNote (syllable);
      break;
...
//
//         case lpsrLyricsDurationsKind::kLyricsDurationsExplicit:
// //           handleLyricExtenderIfAnyAutomatically (
// //             syllable);
//           break;
//       } // switch
//       break;
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyAutomaticallySyllableSingle (
  const S_msrSyllable& syllable)
{
//       gOutput << // JMI 2026.2
//         ">>> CHECK!!! " <<
...
//         std::endl;
  ...
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ CODE_FOR_EXTENDER_AUTOMATIC_DURATIONS_kSyllableSingle" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyAutomaticallySyllableBegin (
  const S_msrSyllable& syllable)
{
#ifdef MF_TRACE_IS_ENABLED
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ CODE_FOR_EXTENDER_AUTOMATIC_DURATIONS_kSyllableBegin" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyAutomaticallySyllableMiddle (
  const S_msrSyllable& syllable)
{
#ifdef MF_TRACE_IS_ENABLED
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ CODE_FOR_EXTENDER_AUTOMATIC_DURATIONS_kSyllableMiddle" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
...
//       doGenerateADoubleUnderscore = true;
  ...
  // should a single underscore be generated?
  // ----------------------------------------------------
  if (doGenerateASingleleUnderscore) {
    fLilypondCodeStream <<
      cLilypondSingleUnderscore;
  }
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyAutomaticallySyllableMiddle_kSyllableSkipOnRegularNote (
  const S_msrSyllable& syllable)
{
#ifdef MF_TRACE_IS_ENABLED
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ CODE_FOR_EXTENDER_AUTOMATIC_DURATIONS_kSyllableSkipOnRegularNote" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyAutomaticallySyllableEnd (
  const S_msrSyllable& syllable)
{
#ifdef MF_TRACE_IS_ENABLED
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ CODE_FOR_EXTENDER_AUTOMATIC_DURATIONS_kSyllableEnd" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
  ...
  if (noteTheSyllableIsAttachedTo) {
    // take note's ties into account if any
    const std::list <S_msrTie>& noteTiesList =
      noteTheSyllableIsAttachedTo->getNoteTiesList ();
...
// void lpsr2lilypondTranslator::handleLyricExtenderIfAnyAutomatically (
//   const S_msrSyllable& syllable)
// {
// /*
...
// */
//
//   // the way lyrics are presented in the LilyPond documentation KRAKRA
//   // is not organized acccording to an automatic/explicit dichotomy,
...
//         fLilypondCodeStream <<
//           std::endl <<
//           "%{ CODE_FOR_EXTENDER_AUTOMATIC_DURATIONS_kSyllableNone" <<
//           ", " << syllable->getInputLineNumber () <<
//           " %}" <<
//           std::endl;
//       }
...
//     case msrSyllableKind::kSyllableEnd:
//     // ----------------------------------------------------
// //       handleLyricExtenderIfAnyAutomaticallySyllableEnd (
// //         syllable);
//       break;
//
//     // ----------------------------------------------------
...
//         fLilypondCodeStream <<
//           std::endl <<
//           "%{ CODE_FOR_EXTENDER_AUTOMATIC_DURATIONS_kSyllableOnRestNote" <<
//           ", " << syllable->getInputLineNumber () <<
//           " %}" <<
//           std::endl;
//       }
...
//         fLilypondCodeStream <<
//           std::endl <<
//           "%{ CODE_FOR_EXTENDER_AUTOMATIC_DURATIONS_kSyllableSkipOnRestNote" <<
//           ", " << syllable->getInputLineNumber () <<
//           " %}" <<
//           std::endl;
//       }
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyExplicitlySyllableSingle (
  const S_msrSyllable& syllable)
{
//       gOutput << // JMI 2026.2
//         ">>> CHECK!!! " <<
...
//         std::endl;
  ...
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ CODE_FOR_EXTENDER_EXPLICIT_DURATIONS_kSyllableSingle" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
...
//       doGenerateADoubleUnderscore = true; // KRAKRA
    ...
    case msrSyllableExtendKind::kSyllableExtendTypeLess:
//       fOnGoingExtend = true; // KRAKRA KRAKRA KRAKRA
//
//       if (fOnGoingExtend) {
//         doGenerateADoubleUnderscore = true; // KRAKRA
//       }
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyExplicitlySyllableBegin (
  const S_msrSyllable& syllable)
{
#ifdef MF_TRACE_IS_ENABLED
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ %{ CODE_FOR_EXTENDER_EXPLICIT_DURATIONS_kSyllableBegin" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
  ...
  if (noteTheSyllableIsAttachedTo) {
    // take note's slurs into account if any
    const std::list <S_msrSlur>&
      noteSlursList =
        noteTheSyllableIsAttachedTo->getNoteSlursList ();
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyExplicitlySyllableMiddle (
  const S_msrSyllable& syllable)
{
#ifdef MF_TRACE_IS_ENABLED
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ %{ CODE_FOR_EXTENDER_EXPLICIT_DURATIONS_kSyllableMiddle" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyExplicitlySyllableMiddle_kSyllableSkipOnRegularNote (
  const S_msrSyllable& syllable)
{
#ifdef MF_TRACE_IS_ENABLED
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ %{ CODE_FOR_EXTENDER_EXPLICIT_DURATIONS_kSyllableSkipOnRegularNote_II" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyExplicitlySyllableEnd (
  const S_msrSyllable& syllable)
{
#ifdef MF_TRACE_IS_ENABLED
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
    fLilypondCodeStream <<
      std::endl <<
      "%{ %{ CODE_FOR_EXTENDER_EXPLICIT_DURATIONS_kSyllableEnd" <<
      ", " << syllable->getInputLineNumber () <<
      " %}" <<
      std::endl;
  }
...
void lpsr2lilypondTranslator::handleLyricExtenderIfAnyExplicitly (
  const S_msrSyllable& syllable)
{
/*
  Multiple notes to one syllable:
  ...
  switch (syllable->getSyllableKind ()) {
    ...
    // ----------------------------------------------------
      ...
      if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
        fLilypondCodeStream <<
          std::endl <<
          "%{ %{ CODE_FOR_EXTENDER_EXPLICIT_DURATIONS_kSyllableNone" <<
          ", " << syllable->getInputLineNumber () <<
          " %}" <<
          std::endl;
      }
    ...
    case msrSyllableKind::kSyllableEnd:
    // ----------------------------------------------------
      handleLyricExtenderIfAnyExplicitlySyllableEnd (
        syllable);
      break;
    ...
    // ----------------------------------------------------
      ...
      if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
        fLilypondCodeStream <<
          std::endl <<
          "%{ %{ CODE_FOR_EXTENDER_EXPLICIT_DURATIONS_kSyllableOnRestNote" <<
          ", " << syllable->getInputLineNumber () <<
          " %}" <<
          std::endl;
      }
    ...
    // ----------------------------------------------------
      ...
      if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
        fLilypondCodeStream <<
          std::endl <<
          "%{ %{ CODE_FOR_EXTENDER_EXPLICIT_DURATIONS_kSyllableSkipOnRestNote" <<
          ", " << syllable->getInputLineNumber () <<
          " %}" <<
          std::endl;
      }
...
//         doGenerateASkip = true;
    ...
    // ----------------------------------------------------
      ...
      if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondLyrics ()) {
        fLilypondCodeStream <<
          std::endl <<
          "%{ %{ CODE_FOR_EXTENDER_EXPLICIT_DURATIONS_kSyllableSkipOnRegularNote_I" <<
          ", " << syllable->getInputLineNumber () <<
          " %}" <<
          std::endl;
      }
...
// #endif // MF_TRACE_IS_ENABLED
//
//   // should a skip with duration be generated?
//   // ----------------------------------------------------
//   if (doGenerateASkip) {
//     fLilypondCodeStream <<
//       cLilyPondSpace <<
...
*/
  ...
  // is there an ongoing multi-measure rest?
  ...
  if (! chordBeamsList.empty ()) {
    ...
    for ( S_msrBeam chordBeam : chordBeamsList) {
      switch (chordBeam->getBeamKind ()) {
        ...
        case msrBeamKind::kBeamBegin:
          if (chordBeam->getBeamNumber () == 1) { // JMI 2026.2
            fLilypondCodeStream << "[ ";
            if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondChords ()) {
...
#ifdef MF_TRACE_IS_ENABLED
  if (gGlobalLpsr2lilypondOahGroup->getCommentLilypondMultiMeasureRests ()) {
    fLilypondCodeStream <<
      "% nextBarPuristNumber: " <<
      nextBarPuristNumber <<
      ", fOnGoingMultiMeasureRests: " <<
...
void lpsr2lilypondTranslator::visitEnd (S_msrMultiMeasureRest& elt)
{
  ...
  // get multi-measure rests sounding notes JMI USELESS 0.9.63
  mfWholeNotes
